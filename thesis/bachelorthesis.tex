...
\begin{document}
  ...
  supports \texttt{while} loops, \texttt{do-while} loops and variable assignment. Two significant
  differences from C-like languages are the syntax required to specify parameter types and the lack
  of \texttt{for} loops. A more complex program example can be seen in figure \ref{ex1}.

  The evaluation strategy of Devin is strict. Function arguments are passed by value by default;
