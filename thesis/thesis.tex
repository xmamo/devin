...
\begin{document}
  ...
  Here, \lstinline@()@ denotes the empty tuple; its value is ignored by the
  function lifted by \lstinline@liftA2@. Using \lstinline@const x _ = x@ as
  defined in the \lstinline@Prelude@, \lstinline@amap@ can be simplified to:
