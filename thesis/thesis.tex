...
\begin{document}
  ...
  \begin{lstlisting}[gobble=4,basicstyle=\ttfamily\small]
    ...
    compareVals v1 v2 = case (v1, v2) of
      ...
      (Array rs1, Array rs2) -> do
        let length = Vector.length rs1
        if Vector.length rs2 /= length then pure False else go n 0
  ...
  Devin's UI implementation is complex, requiring more than 900 lines of code.
